...
- a schema-17-introduced local application-compatibility rehearsal with a current 152-file schema-49 engineering manifest, five pinned runtime versions, state/report/generation checks, frozen safety replay, current-schema restore prerequisite, and a separate non-deployment evidence chain;
